...
sdoh_json_variable_map = {
    ...
    "lon": "Longitude",
    "lat": "Latitude",
    "ACS_PCT_INC50_ABOVE65": "Pct. population with income-to-poverty ratio < 0.50 (ages 65+)",
    "ACS_PCT_INC50_BELOW17": "Pct. children with income-to-poverty ratio < 0.50 (ages <=17)",
    ...
    "ACS_PCT_COLLEGE_ASSOCIATE_DGR": "Pct. population with some college or associate's degree (ages 25+)",
    "ACS_PCT_BACHELOR_DGR": "Pct. population with bachelor's degree (ages 25+)",
    "ACS_PCT_GRADUATE_DGR": "Pct. population with graduate/professional degree (ages 25+)",
    "ACS_PCT_HS_GRADUATE": "Pct. population with high school diploma only (ages 25+)",
    "ACS_PCT_LT_HS": "Pct. population with less than high school education (ages 25+)",
    "ACS_PCT_POSTHS_ED": "Pct. population with any post-high school education (ages 25+)",
    "ACS_TOT_CIVIL_EMPLOY_POP": "Total civilian employed population (ages 16+)",
    "ACS_PCT_UNINSURED": "Pct. population with no health insurance",
    "HIFLD_MIN_DIST_UC": "Min. distance (miles) to nearest urgent care (pop-weighted)",
    "POS_MIN_DIST_ED": "Min. distance (miles) to nearest emergency department (pop-weighted)",
    "POS_MIN_DIST_ALC": "Min. distance (miles) to nearest inpatient alcohol/drug abuse care (pop-weighted)",
    "ACS_PCT_DISABLE": "Pct. population with a disability",
    "ACS_PCT_NONVET_DISABLE_18_64": "Pct. nonveterans with a disability (ages 18-64)",
    "ACS_PCT_VET_DISABLE_18_64": "Pct. civilian veterans with a disability (ages 18-64)",
}
